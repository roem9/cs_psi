        ...
        <div class="container-xl">
            ...
            <li class="nav-item dropdown" id="Produk">
                ...
                <li class="nav-item" id="pengaturan">
                    <a class="nav-link btnLoading" href="<?= base_url()?>app/pengaturan" role="button" aria-expanded="false" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                            <svg width="24" height="24" class="me-3">
                                <use xlink:href="<?= base_url()?>assets/tabler-icons-1.39.1/tabler-sprite.svg#tabler-settings" />
                            </svg> 
                        </span>
                        <span class="nav-link-title">
                            Pengaturan
